          ...
          {loading ? (
            ...
            <>
              ...
              <div className="card-grid">
                {/* 01. ACTIVE RUNNING COURSE: Free English Bootcamp */}
                {(selectedCategory === "all" || selectedCategory === "english-communication") &&
                 (selectedLevel === "all" || selectedLevel === "beginner") &&
                 (!searchQuery || "zero to fluent free english bootcamp".includes(searchQuery.toLowerCase())) && (
                ...
                {/* 02. OTHER FLAGSHIP COURSES: COMING SOON */}
                {courses.map((course) => (
